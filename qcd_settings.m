...
%% Print
caption_name = "Relative error, runtime, number of restart cycles, number of matrix-vector products, and maximum number of stored vectors for the inverse square root function in the QCD example.";
label_name = "qcd";
