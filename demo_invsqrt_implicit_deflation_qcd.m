...
method_list = ["benchmark", ...  % yes
    "fix FOM-t", ...
    "fix FOM-t last-orth", ...  % yes
    "fix FOM-t last-sorth", ...  % yes
    "fix FOM-s", ...
    "ada FOM-t last-orth", ...  % yes
    "ada FOM-t last-sorth", ...  % yes
    "ada FOM-s last-orth", ...
    "ada FOM-s last-sorth"];
method_name = "ada FOM-t last-orth";
