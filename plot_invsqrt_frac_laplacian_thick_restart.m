...
data_prefix = "./data/frac_laplacian_invsqrt_thick_restart/";
figure_prefix = "./figure/frac_laplacian_invsqrt_thick_restart/frac_laplacian_invsqrt_thick_restart";
...
for it = 1 : num_result
    ...
    legend('without thick restart', 'with thick restart')
    xlabel('cycle');
    ylabel('rel err');
    title(display_name);
    hold off;
