function print_table_thick_restart(data_prefix, f_ex, ...
    method_list, ...
...
for it_method = 1 : num_method
    ...
    if endsWith(method_name, "_t")
        for it_trunc = 1 : num_truncate_len
            ...
            print_result(result_without_thick_restart, f_ex);
            print_result(result_with_thick_restart, f_ex);
        end
    else
...
function print_result(result, f_ex)
