...
tic;
[f_fom_t, out_fom_t] = funm_quad_fom_last_orth_tarnoldi(A,Ab,t_param);
t_fom_t = toc;
...
tic;
[f_sfom_t, out_sfom_t] = funm_quad_sfom_last_sorth_tarnoldi(A,Ab,st_param);
t_sfom_t = toc;
...
tic;
[f_fom_s, out_fom_s] = funm_quad_fom_last_orth_sarnoldi(A,Ab,s_param);
t_fom_s = toc;
...
tic;
[f_sfom_s, out_sfom_s] = funm_quad_sfom_last_sorth_sarnoldi(A,Ab,ss_param);
t_sfom_s = toc;
...
tic;
[f_afom_t, out_afom_t] = funm_quad_ada_fom_last_orth_tarnoldi(A,Ab,at_param);
t_afom_t = toc;
...
tic;
[f_asfom_t, out_asfom_t] = funm_quad_ada_sfom_last_sorth_tarnoldi(A,Ab,ast_param);
t_asfom_t = toc;
...
%% save data
file_name = "./data/frac_laplacian/frac_laplacian_" + string(N) + "_" + string(m) + "_" + string(truncation_length) + ".mat";
save(file_name, ...
    "f", "out", "t", ...
